        ...
        <div className="mx-auto min-h-screen max-w-3xl px-4 py-5 sm:px-6">
          <header className="mb-5 flex items-center justify-between gap-4">
            <div>
              ...
              <span className="mt-1 block pl-[3.25rem] text-[11px] font-semibold leading-tight text-slate-400">
                Developed by{" "}
                <a
            ...
            <nav className="flex gap-2 text-sm font-bold text-slate-600">
              <Link href="/groups" className="rounded-full bg-white px-3 py-2 shadow-sm">
                Groups
              </Link>
              <Link href="/about" className="rounded-full bg-white px-3 py-2 shadow-sm">
                About
              </Link>
            </nav>
          </header>
